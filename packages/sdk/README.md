...
Need the local worker? Install [`codexdock`](https://www.npmjs.com/package/codexdock). The CLI connects to the routes exposed by this SDK and runs pending invocations through the local Codex app-server runtime.
